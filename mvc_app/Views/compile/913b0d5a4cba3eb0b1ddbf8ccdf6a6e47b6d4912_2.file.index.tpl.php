...
function content_648036f8a3dd52_28448935 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="col-lg-6 mx-auto col-md-8">
            ...
            <form action="/contact/create" method="post" class="bg-white p-3 rounded mb-5">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" name="email" placeholder="sample@email">
